        ...
        <View style={styles.container}>
            ...
            <View style={styles.buttons}>
                <Link href={'/login'} asChild style={[defaultStyles.pillButton, { flex:1, backgroundColor: Colors.dark}]} >
                    <TouchableOpacity>
                        <Text style={{ color: "white",fontSize:22, fontWeight:520 }}>Log in </Text>
                    </TouchableOpacity>
                </Link>
                <Link href={'/signup'} asChild style={[defaultStyles.pillButton, { flex:1, backgroundColor: Colors.white}]} >
                    <TouchableOpacity>
                        <Text style={{ fontSize:22, fontWeight:520 }}>Sign Up</Text>
                    </TouchableOpacity>
                </Link>
            </View>
        </View>
